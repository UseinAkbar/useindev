...
const Header = () => {
    return (
        <header className="header">
            ...
            Hello👋, My name is <strong>Usein Akbar</strong> and I'm a <strong>Frontend Developer</strong> with several years of experiences building web applications. I have the ability to build responsive and interactive web applications, represented UI design in code, and integrate APIs.
            <br />
            <br />
